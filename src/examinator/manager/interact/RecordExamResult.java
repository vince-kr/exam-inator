...
public class RecordExamResult implements Interaction {
    ...
    private int askDuration() {
        ...
        return getValidPositiveInteger(prompt, 180);
    }
    ...
    private int askGrammarScore() {
        ...
        return getValidPositiveInteger(prompt, 100);
    }
    ...
    private int askWordLimit() {
        ...
        return getValidPositiveInteger(prompt, 10000);
    }
    ...
    private int askNumQuestions() {
        ...
        return getValidPositiveInteger(prompt, 50);
    }
